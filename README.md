# nvim-treesitter-queries-swift

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-swift/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-swift/actions/workflows/validate.yml)

Neovim tree-sitter queries for **swift**, part of the
...
- [ ] Changes are scoped to `swift` — do not include files for other languages
